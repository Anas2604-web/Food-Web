export default async function handler(req, res) {
  ...
  try {
    ...
    if (type === "menu" && restaurantId) {
      ...
      apiUrl = `https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=${lat}&lng=${lng}&restaurantId=${restaurantId}`;
    } else {
      // Fetch restaurant listing (default)
